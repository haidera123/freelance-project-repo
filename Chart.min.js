                    ...
                    return n.labels.length && n.datasets.length
                      ? n.labels.map(function (i, a) {
                          var o = t.getDatasetMeta(0),
                            ...
                            h = s.borderColor
                              ? s.borderColor
                              : u(r.borderColor, a, d.borderColor),
                            f = s.borderWidth
                              ? s.borderWidth
                              : u(r.borderWidth, a, d.borderWidth);
                          return {
                            text: i,
                            fillStyle: c,
                            strokeStyle: h,
              ...
              (t.controllers.polarArea = t.DatasetController.extend({
                ...
                updateElement: function (t, n, i) {
                  ...
                  var b = l.startAngle,
                    x = t.hidden
                      ? 0
                      : u.getDistanceFromCenterForValue(r.data[n]),
                    y = b + h * p,
                    k = y + (t.hidden ? 0 : h),
                    w = s.animateScale
                      ? 0
            ...
            (t.defaults.radar = {
              ...
              (t.controllers.radar = t.DatasetController.extend({
                ...
                removeHoverStyle: function (t) {
                  ...
                  (o.radius = i.radius
                    ? i.radius
                    : e.getValueAtIndexOrDefault(n.pointRadius, a, r.radius)),
              ...
              a.extend(t.prototype, {
                  ...
                  if (
                    (a.each(
                      ...
                      function (a, o) {
                        ...
                        if (
                          (r.type || (r.type = a.type || e.config.type),
                          n.push(r.type),
                          r.controller)
                        )
                ...
                updateDataset: function (t) {
                  var e = this,
                    ...
                    i = { meta: n, index: t };
                  o.notify(e, "beforeDatasetUpdate", [i]) !== !1 &&
                    (n.controller.update(),
                ...
                drawDataset: function (t, e) {
                  ...
                  o.notify(n, "beforeDatasetDraw", [a]) !== !1 &&
                    (i.controller.draw(e),
            ...
            function n(t, e) {
              ...
              for (i = 0, o = l.length; i < o; ++i)
                if (t.isDatasetVisible(i))
                  for (
                    n = t.getDatasetMeta(i), a = 0, r = n.data.length;
                    a < r;
                    ++a
                  ) {
                    var s = n.data[a];
                ...
                fit: function () {
                  ...
                  if (
                    ...
                    if (d) {
                      ...
                      0 !== t.labelRotation
                        ? ((t.paddingLeft =
                            "bottom" === o.position ? b * w + 3 : b * m + 3),
                          (t.paddingRight =
                            "bottom" === o.position ? b * m + 3 : b * S + 3))
                        : ((t.paddingLeft = w / 2 + 3),
                ...
                draw: function (e) {
                  ...
                  if (o.display) {
                    ...
                    if (c.drawBorder) {
                      ...
                      p
                        ? ((V = O = "top" === o.position ? a.bottom : a.top),
                          (V += z),
                          (O += z))
                        : ((R = L = "left" === o.position ? a.right : a.left),
                          (R += z),
                          (L += z)),
                        s.beginPath(),
                        s.moveTo(R, V),
            ...
            return (
              ...
              (t.Legend = t.Element.extend({
                ...
                fit: function () {
                  ...
                  if (
                    (m
                      ? ((p.width = n.maxWidth), (p.height = r ? 10 : 0))
                      : ((p.width = r ? 10 : 0), (p.height = n.maxHeight)),
                    r)
                  )
                    if (((l.font = f), m)) {
                      ...
                      (l.textAlign = "left"),
                        ...
                        i.each(n.legendItems, function (t, i) {
                          ...
                          v[v.length - 1] + r + o.padding >= n.width &&
                            ((b += d + o.padding), (v[v.length] = n.left)),
                      ...
                      i.each(n.legendItems, function (t, n) {
                        ...
                        M + S > p.height &&
                          ((k += w + o.padding), y.push(w), (w = 0), (M = 0)),
                          (w = Math.max(w, a)),
                          (M += S),
                    ...
                    i.each(n.legendItems, function (t, e) {
                      ...
                      w
                        ? r + a >= s &&
                          ((l = d.y += M),
                          d.line++,
                          (r = d.x = n.left + (s - u[d.line]) / 2))
                        : l + M > n.bottom &&
                          ((r = d.x = r + n.columnWidths[d.line] + o.padding),
              ...
              })),
              {
                ...
                beforeUpdate: function (e) {
                  var o = e.options.legend,
                    r = e.legend;
                  o
                    ? ((o = i.configMerge(t.defaults.global.legend, o)),
                      r ? (a.configure(e, r, o), (r.options = o)) : n(e, o))
            ...
            return (
              ...
              (t.Title = t.Element.extend({
                ...
                fit: function () {
                  ...
                  e.isHorizontal()
                    ? ((s.width = e.maxWidth),
                      (s.height = r ? l + 2 * a.padding : 0))
                    : ((s.width = r ? l + 2 * a.padding : 0),
              ...
              })),
              {
                ...
                beforeUpdate: function (a) {
                  var o = a.options.title,
                    r = a.titleBlock;
                  o
                    ? ((o = n.configMerge(t.defaults.global.title, o)),
                      r ? (i.configure(a, r, o), (r.options = o)) : e(a, o))
                    : r &&
                      (t.layoutService.removeBox(a, r), delete a.titleBlock);
                },
              }
            );
          };
                ...
                getPixelForValue: function (t, e, n, i) {
                  ...
                  if (o.isHorizontal()) {
                    var u = o.width / r,
                      d = u * (e - o.minIndex);
                    return (
                      ((o.options.gridLines.offsetGridLines && i) ||
                        (o.maxIndex === o.minIndex && i)) &&
                        (d += u / 2),
                      o.left + Math.round(d)
                    );
                  }
                  var c = o.height / r,
                    h = c * (e - o.minIndex);
                  return (
                    o.options.gridLines.offsetGridLines && i && (h += c / 2),
                    o.top + Math.round(h)
                  );
                },
                getPixelForTick: function (t, e) {
                  ...
                  if (
                    ...
                    e.each(r, function (o, r) {
                      var l = a.getDatasetMeta(r),
                        s = [
                          l.type,
                          void 0 === i.stacked && void 0 === l.stack ? r : "",
                          l.stack,
                        ].join(".");
                      void 0 === c[s] &&
              ...
              i = t.Scale.extend({
                      ...
                      o.isDatasetVisible(r) &&
                        ...
                        e.each(a.data, function (t, e) {
                          ...
                          isNaN(o) ||
                            l.data[e].hidden ||
                            ((a[e] = a[e] || 0),
                            i.relativePoints ? (a[e] = 100) : (a[e] += o));
                        }));
                    }),
                      e.each(c, function (t) {
                        var i = e.min(t),
                    ...
                    o.isHorizontal()
                      ? ((a = e.log10(o.end) - e.log10(r)),
                        0 === l
                          ? (i = o.left)
                          : ((n = o.width),
                            (i = o.left + (n / a) * (e.log10(l) - e.log10(r)))))
                      : ((n = o.height),
                        0 !== r || u.reverse
                          ? 0 === o.end && u.reverse
                            ...
                            : ((a = e.log10(o.end) - e.log10(r)),
                              (n = o.height),
                              (i =
                                o.bottom - (n / a) * (e.log10(l) - e.log10(r))))
                ...
                getValueForPixel: function (t) {
                  ...
                  return (
                    a.isHorizontal()
                      ? ((i = a.width),
                        (n = a.start * Math.pow(10, ((t - a.left) * o) / i)))
                      : ((i = a.height),
                        (n = Math.pow(10, ((a.bottom - t) * o) / i) / a.start)),
                    n
                  );
                },
              });
            ...
            function o(t) {
              ...
              for (o = 0; o < h; o++) {
                (l = t.getPointPosition(o, u)),
                  (r = i(t.ctx, s.size, t.pointLabels[o] || "")),
        ...
        function (t, e, n) {
          ...
          (i = "function" == typeof i ? i : window.moment),
            (e.exports = function (t) {
              ...
              function n(t, e, n, i) {
                for (
                  var a, o = Object.keys(l), r = o.length, s = o.indexOf(t);
                  s < r;
                  s++
                ) {
                  a = o[s];
                ...
                getPixelForValue: function (t, n, i) {
                  ...
                  if (
                    ...
                    null === o &&
                      ...
                      t && t.isValid && t.isValid() && (o = t.valueOf())),
                    null !== o)
                  )
